        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            ...
            <p className="text-sm text-gray-400 mt-2">
              ...
              <br />
              Sitio Desarrollado por <a href="https://www.linkedin.com/in/martin-gabriel-capece-a97415253/" target="_blank" rel="noopener noreferrer" className="underline">Martin Capece</a>.
            </p>
          </div>
        </div>
      </div>
